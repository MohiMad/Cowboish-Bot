...
module.exports = {
    ...
    execute(message, args){
        ...
        if (!args[1]) then.message.channel.send(infos[info]);

            var infos = [message.author.username + " Is the coordinator who misses her flare gun",
            ...
            "Pls hunter be friendly i luv u :heart: thats what " + persona.username + ' usually says' ,
