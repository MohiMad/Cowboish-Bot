...
module.exports = {
    ...
    execute: async (message, args, bot, prefix) => {
        ...
        let notusedembed = new Discord.MessageEmbed()
            .setAuthor("", survivorIcon)
            .setColor("#15f153")
            .setDescription("**Overview:**\nTEXTHERE\n\n**Background:**\nTEXTHERE\n\n**《 External traits 》**\n\n")
            .setFooter(`The Survivors - Page x of 30 | Information taken from IdentityV wiki`)
            .setImage("");
        ...
        let luckyguy = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 1 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/687700563282231391/Lucky_Guy_Portrait.png")


        let doctor = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 2 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/710143048411119747/Emily_Dyer_Portrait.png")


        let gardener = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 3 of 30 | Information taken from IdentityV wiki`)
        ...
        let lawyer = new Discord.MessageEmbed()
        ...
        let explorer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 7 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/712249321432809482/Kurt_Frank_Portrait.png");

        let mercenary = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 8 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/712618464606552174/Naib_Subedar_Portrait.png");

        let coordinator = new Discord.MessageEmbed()
        ...
        let mechanic = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 10 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/712621838114750535/100px-Tracy_Reznik.png");

        let forwardy = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 11 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://media.discordapp.net/attachments/673091096946933790/712625290173481030/William_Ellis_Portrait.png");


        let mindseye = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 12 of 30 | Information taken from IdentityV wiki`)
            .setImage("");

        let priestess = new Discord.MessageEmbed()
        ...
        let perfumer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 14 of 30 | Information taken from IdentityV wiki`)
        ...
        let cowboy = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 15 of 30 | Information taken from IdentityV wiki`)
            .setImage(bot.user.displayAvatarURL);

        let dancer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 16 of 30 | Information taken from IdentityV wiki`)
        ...
        let seer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 17 of 30 | Information taken from IdentityV wiki`)
        ...
        let embalmer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 18 of 30 | Information taken from IdentityV wiki`)
        ...
        let prospector = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 19 of 30 | Information taken from IdentityV wiki`)
        ...
        let enchantress = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 20 of 30 | Information taken from IdentityV wiki`)
        ...
        let wildling = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 21 of 30 | Information taken from IdentityV wiki`)
        ...
        let acrobat = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 22 of 30 | Information taken from IdentityV wiki`)
        ...
        let officer = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 23 of 30 | Information taken from IdentityV wiki`)
        ...
        let barmaid = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 24 of 30 | Information taken from IdentityV wiki`)
        ...
        let postman = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 25 of 30 | Information taken from IdentityV wiki`)
        ...
        let gravekeeper = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 26 of 30 | Information taken from IdentityV wiki`)
        ...
        let prisoner = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 27 of 30 | Information taken from IdentityV wiki`)
        ...
        let entomologist = new Discord.MessageEmbed()
            ...
            .setFooter(`The Survivors - Page 28 of 30 | Information taken from IdentityV Fandom`)
        ...
        let painter = new Discord.MessageEmbed()
            .setAuthor("The Painter - Edgar Walden", survivorIcon, "https://id5.fandom.com/wiki/Edgar_Walden")
            .setColor("#15f153")
            .setDescription("**Background:**\The only son in the Walden family of aristocrats, Edgar showed an interest and high talent in painting from childhood. Praise from his family and the public has led to his eccentric character. He only sees art from his own perspective and has a high self-esteem. His perception of the world around him led to his belief that nobody else is worthy to speak to him about art. \nHe did not participate in the game for the prize. As the heir to the Walden family, money did not tempt him. So what made him participate in this game?\n\n**《 External traits 》**\n\n**Artistic Sensitivity:** He carries a paintbrush and a drawing board with him. Once he has memorized a Hunter's face, the Painter can paint the Hunter's face on the drawing board.\nWhen the painting is done, he can place the drawing board in the scene. When the Hunter sees the placed drawing board, they will be attracted by it, walk over involuntarily and stop to admire their face in front of it.\nIf the Hunter takes too much time walking over to the drawing board, they will lose interest in the painting which renders the drawing board useless.\n\n*Memories*: Within a certain range of a Hunter, the Painter needs to look at the Hunter's face from the front to memorize it.\n\n*Painting*: Once he has memorized the Hunter's face, tap the ability button to begin painting. The Painter can move while painting but cannot interact. Tap the ability button again to stop painting.\n\n*Placing the drawing*: When the painting is done, tap the ability button to place the drawing board. The Hunter will be forcibly attracted when they get close to the drawing board. No additional drawing boards can be placed within the effective range of the placed drawing board.")
            .addField("Aesthetic Resonance", " During the creation of a painting, the Painter will be affected by his own work. Every time he places a painting, his movement speed will increase permanently by **2%**. This effect can be stacked up to **3** times.")
            .addField("Intuition", "The Painter is perceptive and observant to real-life objects and so he will not be affected by a Rocket Chair with **50%** progress. When he is put on a Rocket Chair for the second time, the progress will return to what it was the last time he was saved.")
            .addField("Self Fulfillment", "When the painting's effect wears off, the Hunter will be extremely interested in its painter. The Painter will expose his location to the Hunter for **5** seconds.")
            .setFooter(`The Survivors - Page 29 of 30 | Information taken from IdentityV Fandom`)
            .setImage("https://static.wikia.nocookie.net/id5/images/4/4a/Artist_Transparent.png/revision/latest?cb=20200924174637");
        
        let batter = new Discord.MessageEmbed()
            .setAuthor("The Batter - Ganji Gupta", survivorIcon)
            .setColor("#15f153")
            .setDescription("**Background:**\nRage ignites the spark and dissipates the smog. It also makes gentlemen repent of their sins before they crumble to dust. Love. Happiness. The hope and pride. I wouldn't have any of this if it wasn't for this sport. And yet, when I was brought here, I finally realized that these gentlemen just need a suitable toy for fun. The funny thing is that they themselves were far from gentlemanly. All they craved was our submission and servitude. The searing heat seemed to warn me. Stop being nice to everyone. I need a new identity. I want to go home. This may be the only place where there is still hope.\n\n**《 External traits 》**\n\n**[Cricket bat]**\nCarries a cricket bat with him. Tap or hold the ability button to hit the ball in the specified direction. The longer the hold, the harder the ball is hit. When flying in the air, the impact force of the ball will gradually decrease. When a cricket ball hits the hunter, He pushes it away. The harder the ball is hit, the further the Hunter will be repelled. A batsman can pick up a dropped cricket ball to increase the number of uses of the bat.\n\n**[Break out]**\nYou can concentrate to enter the Burst state, lasting 20 seconds. Cooldown is 40 seconds. After the ball in the burst state pushes the Hunter away and the Hunter collides with an obstacle, he gets dizzy. The greater the distance the Hunter is pushed, the longer the dizziness will last. When hitting a ball in such an burst state, each cricket ball is broken immediately after hitting an obstacle and cannot be picked up.")
            .addField("[Sense of Duty]", "You have a strong sense of responsibility when saving your allys and do not turn a blind eye to danger. When a Survivor within 18 meters of you is attacked by a Hunter, if he is not chased, the movement speed increases by 50% for 10 seconds. Cooldown 60 seconds.\n\n\n**[Mechanical noise]**\nClumsy and unable to use mechanical devices, speed decryption machine is reduced by 20%")
            .setFooter(`The Survivors - Page 30 of 30 | Information taken from IdentityV wiki`)
            .setImage("https://i.imgur.com/9qy7mdo.png");
            //Some embed valuesa

        //Hunter embeds starts HEREEEEE


        let notusedHUNTERembed = new Discord.MessageEmbed()
        ...
        let ripper = new Discord.MessageEmbed()
        ...
        let lizard = new Discord.MessageEmbed()
        ...
        let sculptor = new Discord.MessageEmbed()
            .setAuthor("The Sculptor - Galatea", hunterIcon, "https://id5.fandom.com/wiki/Sculptor")
            .setColor("RED")
        ...
        let redchurch = new Discord.MessageEmbed()
        ...
        let hospital = new Discord.MessageEmbed()
        ...
        let factory = new Discord.MessageEmbed()
        ...
        let lakeside = new Discord.MessageEmbed()
        ...
        let moonlit = new Discord.MessageEmbed()
        ...
        let leosmemory = new Discord.MessageEmbed()
        ...
        let whitesand = new Discord.MessageEmbed()
        ...
        let eversleeping = new Discord.MessageEmbed()
        ...
        let cave = new Discord.MessageEmbed()
        ...
        if (!searchForString) {
            ...
            await switchPages([
                new Discord.MessageEmbed(luckyguy),
                new Discord.MessageEmbed(doctor),
                new Discord.MessageEmbed(gardener),
                new Discord.MessageEmbed(lawyer),
                new Discord.MessageEmbed(theif),
                new Discord.MessageEmbed(magician),
                new Discord.MessageEmbed(explorer),
                new Discord.MessageEmbed(mercenary),
                new Discord.MessageEmbed(coordinator),
                new Discord.MessageEmbed(mechanic),
                new Discord.MessageEmbed(forwardy),
                new Discord.MessageEmbed(mindseye),
                new Discord.MessageEmbed(priestess),
                new Discord.MessageEmbed(perfumer),
                new Discord.MessageEmbed(cowboy),
                new Discord.MessageEmbed(dancer),
                new Discord.MessageEmbed(seer),
                new Discord.MessageEmbed(embalmer),
                new Discord.MessageEmbed(prospector),
                new Discord.MessageEmbed(enchantress),
                new Discord.MessageEmbed(wildling),
                new Discord.MessageEmbed(acrobat),
                new Discord.MessageEmbed(officer),
                new Discord.MessageEmbed(barmaid),
                new Discord.MessageEmbed(postman),
                new Discord.MessageEmbed(gravekeeper),
                new Discord.MessageEmbed(prisoner),
                new Discord.MessageEmbed(entomologist),
                new Discord.MessageEmbed(painter),
                new Discord.MessageEmbed(batter)
            ]);
            ...
            await switchPages([
                new Discord.MessageEmbed(hellember),
                new Discord.MessageEmbed(clown),
                new Discord.MessageEmbed(ripper),
                new Discord.MessageEmbed(gamekeeper),
                new Discord.MessageEmbed(soulweaver),
                new Discord.MessageEmbed(geisha),
                new Discord.MessageEmbed(feaster),
                new Discord.MessageEmbed(wuchang),
                new Discord.MessageEmbed(photographer),
                new Discord.MessageEmbed(madeyes),
                new Discord.MessageEmbed(dreamwitch),
                new Discord.MessageEmbed(axeboy),
                new Discord.MessageEmbed(lizard),
                new Discord.MessageEmbed(bloodyqueen),
                new Discord.MessageEmbed(bonbon),
            ...
            spamStopper.add(message.author);
            await switchPages([
                new Discord.MessageEmbed(redchurch),
                new Discord.MessageEmbed(hospital),
                new Discord.MessageEmbed(factory),
                new Discord.MessageEmbed(lakeside),
                new Discord.MessageEmbed(moonlit),
                new Discord.MessageEmbed(leosmemory),
                new Discord.MessageEmbed(whitesand),
                new Discord.MessageEmbed(eversleeping),
                new Discord.MessageEmbed(cave),
