...
module.exports = {
    ...
    execute: async (message, args, bot, prefix) => {
        ...
        else if (["entomologist", "entomo", "pliny"].includes(args[1].toLowerCase())) {
