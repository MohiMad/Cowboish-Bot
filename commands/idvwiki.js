...
module.exports = {
    ...
    execute: async (message, args, bot) => {
        ...
        let notusedembed = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page x of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("");
        ...
        let luckyguy = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 1 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/687700563282231391/Lucky_Guy_Portrait.png")
        ...
        let doctor = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 2 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/710143048411119747/Emily_Dyer_Portrait.png")
        ...
        let gardener = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 3 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/a/ad/Emma_Woods.png/150px-Emma_Woods.png?version=37d7fd584d404d7c92d3a44a303ff71f");
        ...
        let lawyer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 4 of 27 | Information taken from IdentityV Wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/710145599407915068/Freddy_Riley_Portrait.png")
        ...
        let theif = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 5 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712246534439174154/Kreacher_Pierson_Portrait.png")
        ...
        let magician = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 6 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712247760447078470/Servais_Le_Roy_Portrait.png")
        ...
        let explorer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 7 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712249321432809482/Kurt_Frank_Portrait.png");
        ...
        let mercenary = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 8 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712618464606552174/Naib_Subedar_Portrait.png");
        ...
        let coordinator = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 9 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712620299442716703/Martha_Behamfil_Portrait.png");
        ...
        let mechanic = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 10 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712621838114750535/100px-Tracy_Reznik.png");
        ...
        let forwardy = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 11 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/712625290173481030/William_Ellis_Portrait.png");
        ...
        let mindseye = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 12 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("");
        ...
        let priestess = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 13 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://media.discordapp.net/attachments/673091096946933790/713515937948631091/150px-Fiona_Gilman_Portrait.png");
        ...
        let perfumer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 14 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/9/95/Vera_Nair_Portrait.png?version=c19b27ff2c6de7f2af301a3d7c44a248");
        ...
        let cowboy = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 15 of 27 | Information taken from IdentityV wiki`)
        ...
        let dancer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 16 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/a/ab/Dancer_Portrait2.png?version=1b361c97e666d685ead497c1625c3c75");
        ...
        let seer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 17 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/a/ac/Eli_Clark_Portrait.png?version=feb84b03e6129744d4046042a5068bb1");
        ...
        let embalmer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 18 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/7/71/Aesop_Carr.png?version=a18911ad3feea36165f7fb0e220748c6");
        ...
        let prospector = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 19 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/5/56/Norton_Campbell.png/225px-Norton_Campbell.png?version=ca01595cec989fbc178acf1d63a5302b");
        ...
        let enchantress = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 20 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/c/cf/Patricia_Dorval_FP.png/120px-Patricia_Dorval_FP.png?version=3b336d62399e6d76a53d39191b70feb6");
        ...
        let wildling = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 21 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/5/52/Murro_Portrait.png/225px-Murro_Portrait.png?version=c1ee3e93881743313ecde0d15de88612");
        ...
        let acrobat = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 22 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/3/3c/Mike_Morton_Portrait.png?version=3bf485c5257a7508e9ee6d57eceeab47");
        ...
        let officer = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 23 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/9/9e/Jose_Baden_FP.png/225px-Jose_Baden_FP.png?version=6fa821314e9acd9116855c7e8afc372a");
        ...
        let barmaid = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 24 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/e/e2/Demi_Bourbon_FP.png/317px-Demi_Bourbon_FP.png?version=7d3b97865e6e54e5303283ec855a77de");
        ...
        let postman = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 25 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/a/a8/Victor_Grantz.png/225px-Victor_Grantz.png?version=dceca6eefdcda4adbc55834761c6fb6b");
        ...
        let gravekeeper = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 26 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/3/3c/Andrew_Kress.png/225px-Andrew_Kress.png?version=8639e572f3e70ce67f07c9f4fe291ac3");
        ...
        let prisoner = new Discord.RichEmbed()
            ...
            .setFooter(`The Survivors - Page 27 of 27 | Information taken from IdentityV wiki`)
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/d/d9/Luca_Balsa.png/225px-Luca_Balsa.png?version=d2822008f2db811a142d36eb03b6b81b");
        ...
        let hellember = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/3/34/Leo_Beck.png/212px-Leo_Beck.png?version=66f37472b515f01f23a3578eb8ce1a37");
        ...
        let clown = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/3/3b/Joker2.png/150px-Joker2.png?version=27c3316d234669f44bde3652bb892391");
        ...
        let ripper = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/4/46/Jack.png/224px-Jack.png?version=928726e2df9e0810bd7f04c324aed8ab");
        ...
        let soulweaver = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/f/f1/Violetta.png/375px-Violetta.png?version=9a77c1ce44b1ceb193b63cca814a07b6");
        ...
        let geisha = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/d/db/Michiko.png/303px-Michiko.png?version=5fb97528042c68305c0389bf2e9ac18e");
        ...
        let feaster = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/2/27/Hastur.png/316px-Hastur.png?version=543aa625f334de496f3664bd2e483185");
        ...
        let wuchang = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/d/da/Black_and_White.png/267px-Black_and_White.png?version=317f1bc2f89b07026f5590c2faec413d");
        ...
        let photographer = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/2/2f/Photographer.png/287px-Photographer.png?version=13286090bacdb8beeabfcca4e4874c88");
        ...
        let madeyes = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/a/a7/Mad_Eyes.png/375px-Mad_Eyes.png?version=9977198a06dc4d915f5377b071daefec");
        ...
        let dreamwitch = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/f/f9/Yidhra.png/375px-Yidhra.png?version=9a143b7599beec372640d15f5ec9a37d");
        ...
        let axeboy = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/1/13/Robbie.png/167px-Robbie.png?version=c19a17be9f9bedb3d5acea2c7a151136");
        ...
        let lizard = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/c/c7/Luchino_FP.png/285px-Luchino_FP.png?version=b65d270624a375411af97d8abf36d781");
        ...
        let bloodyqueen = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/6/66/Mary_FP.png/244px-Mary_FP.png?version=3fec4cc960a2bdd09ae32c77e5cb0b7e");
        ...
        let bonbon = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/3/3b/Bonbon_FP.png/347px-Bonbon_FP.png?version=be0b0a248f72f2c4cd100bfb7a107b2e");
        ...
        let ann = new Discord.RichEmbed()
            ...
            .setThumbnail("https://gamepedia.cursecdn.com/identityv_gamepedia_en/thumb/3/30/Ann.png/202px-Ann.png?version=453264cd9eb0631f1dd4e21b68f94af2");
        ...
        let violinist = new Discord.RichEmbed()
            ...
            .setThumbnail("https://vignette.wikia.nocookie.net/id5/images/4/42/Violinist_%28Transparent%29.png/revision/latest/scale-to-width-down/620?cb=20200524021507");
        ...
        if (!args[1]) {
        ...
        } else if (["doc", "doctor", "emily"].includes(args[1].toLowerCase())) {
            message.channel.send(doctor);
        } else if (["lawyer", "freddy"].includes(args[1].toLowerCase())) {
            message.channel.send(lawyer);
        } else if (["theif", "kreacher"].includes(args[1].toLowerCase())) {
            message.channel.send(theif);
        } else if (["magician", "servais"].includes(args[1].toLowerCase())) {
            message.channel.send(magician);
        } else if (["explorer", "kurt"].includes(args[1].toLowerCase())) {
            message.channel.send(explorer);
        } else if (["merc", "mercenary", "naib"].includes(args[1].toLowerCase())) {
        ...
        } else if (["mec", "mechanic", "tracy"].includes(args[1].toLowerCase())) {
            message.channel.send(mechanic);
        } else if (["forward", "william"].includes(args[1].toLowerCase())) {
            message.channel.send(forwardy);
        } else if (["mindseye", "themindseye", "helena"].includes(args[1].toLowerCase())) {
        ...
        } else if (["dancer", "femaledancer", "female", "margaretha"].includes(args[1].toLowerCase())) {
            message.channel.send(dancer);
        } else if (["seer", "eli"].includes(args[1].toLowerCase())) {
            message.channel.send(seer);
        } else if (["embalmer", "aesop"].includes(args[1].toLowerCase())) {
            message.channel.send(embalmer);
        } else if (["prospector", "norton"].includes(args[1].toLowerCase())) {
            message.channel.send(prospector);
        } else if (["enchantress", "patricia"].includes(args[1].toLowerCase())) {
            message.channel.send(enchantress);
        } else if (["wildling", "murro"].includes(args[1].toLowerCase())) {
            message.channel.send(wildling);
        } else if (["mike", "acrobat"].includes(args[1].toLowerCase())) {
            message.channel.send(acrobat);
        } else if (["jose", "officer", "1stofficer"].includes(args[1].toLowerCase())) {
            message.channel.send(officer);
        } else if (["bartender", "barmaid", "demi"].includes(args[1].toLowerCase())) {
            message.channel.send(barmaid);
        } else if (["postman", "victor", "viktor"].includes(args[1].toLowerCase())) {
            message.channel.send(postman);
        } else if (["gravekeeper", "gravedigger", "andrew"].includes(args[1].toLowerCase())) {
            message.channel.send(postman);
        } else if (["prisoner", '"prisoner"', "luca"].includes(args[1].toLowerCase())) {
            message.channel.send(prisoner);
        } else if (["gardener", "emma", "lisa"].includes(args[1].toLowerCase())) {
            message.channel.send(gardener);

        } else if (["hunter", "hunters", "hunta", "killers", "killer", "chaser", "chasers"].includes(args[1].toLowerCase())) {
            ...
            let HunterMsg = await message.channel.send(HunterPages[hunterPageI]);

            await HunterMsg.react('⏪');

            await HunterMsg.react('⏩');

            let HunterBackFilter = (reaction, user) => reaction.emoji.name === '⏪' & user.id === message.author.id;

            let HunterForwardFilter = (reaction, user) => reaction.emoji.name === '⏩' & user.id === message.author.id;
        ...
        } else if (["leo", "hellember"].includes(args[1].toLowerCase())) {
            message.channel.send(hellember);

        } else if (["clown", "smileyface", "smiley", "joker"].includes(args[1].toLowerCase())) {
            message.channel.send(clown);

        } else if (["ripper", "theripper", "jack"].includes(args[1].toLowerCase())) {
            message.channel.send(ripper);

        } else if (["gamekeeper", "thegamekeeper", "bane"].includes(args[1].toLowerCase())) {
            message.channel.send(gamekeeper);

        } else if (["soulweaver", "violetta", "spider", "spooder"].includes(args[1].toLowerCase())) {
            message.channel.send(soulweaver);

        } else if (["geisha", "michiko"].includes(args[1].toLowerCase())) {
            message.channel.send(geisha);

        } else if (["hastur", "feaster"].includes(args[1].toLowerCase())) {
            message.channel.send(feaster);

        } else if (["wu", "wuchang", "blackandwhite", "wuwu", "wuchangus"].includes(args[1].toLowerCase())) {
        ...
        } else if (["madeye", "madeyes", "burke"].includes(args[1].toLowerCase())) {
            message.channel.send(madeyes);

        } else if (["dw", "dreamwitch", "yidhra"].includes(args[1].toLowerCase())) {
            message.channel.send(dreamwitch);

        } else if (["axeboi", "axeboy", "robbie"].includes(args[1].toLowerCase())) {
            message.channel.send(axeboy);

        } else if (["reptile", "evilreptilian", "reptilian", "lizard", "luchino"].includes(args[1].toLowerCase())) {
            message.channel.send(lizard);

        } else if (["bq", "bloodyqueen", "mary"].includes(args[1].toLowerCase())) {
            message.channel.send(bloodyqueen);

        } else if (["guard26", "guard", "no26", "bonbon"].includes(args[1].toLowerCase())) {
            message.channel.send(bonbon);

        } else if (["ann", "disciple", '"disciple"'].includes(args[1].toLowerCase())) {
            message.channel.send(ann);

        } else if (["antontio", "violinist"].includes(args[1].toLowerCase())) {
