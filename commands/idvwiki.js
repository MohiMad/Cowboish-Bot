...
module.exports = {
    ...
    execute: async (message, args, bot) => {
        ...
        let hellember = new Discord.RichEmbed()
            .setAuthor("Hell Ember - Leo Beck", hunterIcon)
            .setColor("RED")
        ...
        let clown = new Discord.RichEmbed()
            .setAuthor("The Smiley Face - Joker", hunterIcon)
            .setColor("RED")
        ...
        let ripper = new Discord.RichEmbed()
            .setAuthor("Jack - The Ripper", hunterIcon)
            .setColor("RED")
        ...
        let gamekeeper = new Discord.RichEmbed()
            .setAuthor("Bane Perez - The Gamekeeper", hunterIcon)
            .setColor("RED")
